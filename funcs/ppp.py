...
"""
from . import gnss as gn
from .peph import gpst2utc, time2epoch
...
def tidedispIERS2010(tutc, pos, sun_pos=None, moon_pos=None, erpv=None):
    """
    IERS2010 solid earth tide displacement (pysolid yerine dahili model)
    """
    if erpv is None:
        erpv = np.zeros(5)
    
    # Güneş ve Ay pozisyonları verilmişse kullan
    ...
    E = gn.xyz2enu(pos)
    dr = solid_tide(rsun, rmoon, pos, E, gmst)
    return dr
