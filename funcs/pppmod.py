...
from .ppp import tidedisp, tidedispIERS2010, uTideModel
from .ppp import shapiro, windupcorr
from .peph import antModelRx, antModelTx
from .typer import sCType
from .typer import sCSSRTYPE as sc
...
class pppos():
    ...
    def erot(self, t, erp):
        """
        Compute Earth rotation matrix for signal propagation time correction
        
        Parameters
        ----------
        t : gtime_t
            GPS time
        erp : array_like or None
        ...
        # Earth rotation angle during signal propagation
        # Typical signal travel time is ~0.07 seconds
        dt = 0.07  # approximate signal propagation time
        
        # Earth rotation rate (rad/s)
        omega_e = 7.2921151467e-5  # WGS84 value
        ...
        Rer = np.array([[cos_theta,  sin_theta, 0],
